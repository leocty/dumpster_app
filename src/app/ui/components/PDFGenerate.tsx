     ...
     <View style={styles.twoColumn}> 
      ...
      <View style={styles.section}>
        ...
        <View style={styles.termsList}>
          <Text style={styles.termsItem}>1. Customer agrees to pay {data.fixContract.fix.customAmount+data.fixContract.fix.landFillCost} (base fee) for the {data.dumpster.size} yd. container which includes up to {data.dumpster.weight} tons of materials as well as any overages incurred due to overloading or additional days requested by the Customer. The containers include up to {data.dumpster.weight} tons, however due to strict weight limitations and associated dump fees any additional materials will be billed at ${data.fixContract.fix.tonsOverWeightAmount} per ton above {data.dumpster.weight} tons.</Text>
